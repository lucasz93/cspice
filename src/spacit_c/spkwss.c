/* spkwss.f -- translated by f2c (version 19991025).
	 ...
	 doublereal *segetm, ftnlen segid_len)
{
    ...
    static thread_local char spktyp[80*21] = "Modified Difference Array     "
	    "                                                  " "Fixed Width"
	    ", Fixed Order Chebyshev Polynomials: Pos                        "
	    "     " "Fixed Width, Fixed Order Chebyshev Polynomials: Pos, Vel"
	    "                        " "TRW Elements (Space Telescope, TDRS) "
	    "                                           " "Two Body Propagati"
	    "on Using Discrete States                                      " 
	    "Type 6                                                         "
	    "                 " "Precession Conic Elements                   "
	    "                                    " "Discrete States, Evenly S"
	    "paced, Lagrange Interpolation                          " "Discre"
	    "te States, Unevenly Spaced, Lagrange Interpolation              "
	    "          " "Two-Line Elements (Short Period)                   "
	    "                             " "Two-Line Elements (Long Period) "
	    "                                                " "Discrete Stat"
	    "es, Evenly Spaced, Hermite Interpolation                        "
	    "   " "Discrete States, Unevenly Spaced, Hermite Interpolation   "
	    "                      " "Variable Width, Fixed order Chebyshev P"
	    "olynomials: Pos, Vel                     " "Two-Body with J2 pre"
	    "cession                                                     " 
	    "ISO elements                                                   "
	    "                 " "Precessing Equinoctial Elements             "
	    "                                    " "Mex/Rosetta Hermite/Lagra"
	    "nge Interpolation                                      " "ESOC/D"
	    "DID Piecewise Interpolation                                     "
	    "          " "Fixed Width, Fixed Order Chebyshev Polynomials: Vel"
	    "                             " "Extended Modified Difference Arr"
	    "ay                                              ";
