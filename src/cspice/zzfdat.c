/* zzfdat.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int zzfdat_(cspice_t* __global_state, integer *ncount, 
	integer *maxbfr, char *name__, integer *idcode, integer *center, 
	integer *type__, integer *typid, integer *centrd, integer *bnmlst, 
	integer *bnmpol, char *bnmnms, integer *bnmidx, integer *bidlst, 
	integer *bidpol, integer *bidids, integer *bididx, ftnlen name_len, 
	ftnlen bnmnms_len)
{
    /* Builtin functions */
    ...
    /* Module state */
    zzfdat_state_t* __state = get_zzfdat_state(__global_state);
/* $ Abstract */
...
/*     Perform the consistency checks first. */
    ...
    if (*ncount != 127) {
	chkin_(__global_state, "ZZFDAT", (ftnlen)6);
	setmsg_(__global_state, "There is an inconsistency between the versi"
		"on of the routine calling ZZFDAT and the current version of "
		"ZZFDAT. Check to make sure that you have the most current ve"
		"rsions of ZZFDAT and the routines that make use of it.", (
		ftnlen)217);
	sigerr_(__global_state, "SPICE(VERSIONMISMATCH1)", (ftnlen)23);
	chkout_(__global_state, "ZZFDAT", (ftnlen)6);
	return 0;
    }
    if (*maxbfr < 127) {
	chkin_(__global_state, "ZZFDAT", (ftnlen)6);
	setmsg_(__global_state, "There is an inconsistency between the versi"
		...
		"rsions of ZZFDAT and the routines that make use of it.", (
		ftnlen)217);
	sigerr_(__global_state, "SPICE(VERSIONMISMATCH2)", (ftnlen)23);
	chkout_(__global_state, "ZZFDAT", (ftnlen)6);
	return 0;
    }
...
/*     Fetch the names of the inertial frames from CHGIRF. */
	...
	type__[i__ - 1] = 1;
	typid[i__ - 1] = i__;
	irfnam_(__global_state, &i__, name__ + (i__ - 1) * name_len, name_len)
		;
    }

/*     Non-Inertial Frames Section. */

    s_copy(&__global_state->f2c, name__ + name_len * 21, "IAU_MERCURY_BARYCE"
	    "NTER", name_len, (ftnlen)22);
    idcode[21] = 10001;
    center[21] = 1;
    typid[21] = 1;
    type__[21] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 22, "IAU_VENUS_BARYCENT"
	    "ER", name_len, (ftnlen)20);
    idcode[22] = 10002;
    center[22] = 2;
    typid[22] = 2;
    type__[22] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 23, "IAU_EARTH_BARYCENT"
	    "ER", name_len, (ftnlen)20);
    idcode[23] = 10003;
    center[23] = 3;
    typid[23] = 3;
    type__[23] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 24, "IAU_MARS_BARYCENTER"
	    , name_len, (ftnlen)19);
    idcode[24] = 10004;
    center[24] = 4;
    typid[24] = 4;
    type__[24] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 25, "IAU_JUPITER_BARYCE"
	    "NTER", name_len, (ftnlen)22);
    idcode[25] = 10005;
    center[25] = 5;
    typid[25] = 5;
    type__[25] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 26, "IAU_SATURN_BARYCEN"
	    "TER", name_len, (ftnlen)21);
    idcode[26] = 10006;
    center[26] = 6;
    typid[26] = 6;
    type__[26] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 27, "IAU_URANUS_BARYCEN"
	    "TER", name_len, (ftnlen)21);
    idcode[27] = 10007;
    center[27] = 7;
    typid[27] = 7;
    type__[27] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 28, "IAU_NEPTUNE_BARYCE"
	    "NTER", name_len, (ftnlen)22);
    idcode[28] = 10008;
    center[28] = 8;
    typid[28] = 8;
    type__[28] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 29, "IAU_PLUTO_BARYCENT"
	    "ER", name_len, (ftnlen)20);
    idcode[29] = 10009;
    center[29] = 9;
    typid[29] = 9;
    type__[29] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 30, "IAU_SUN", name_len, 
	    (ftnlen)7);
    idcode[30] = 10010;
    center[30] = 10;
    typid[30] = 10;
    type__[30] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 31, "IAU_MERCURY", 
	    name_len, (ftnlen)11);
    idcode[31] = 10011;
    center[31] = 199;
    typid[31] = 199;
    type__[31] = 2;
    s_copy(&__global_state->f2c, name__ + (name_len << 5), "IAU_VENUS", 
	    name_len, (ftnlen)9);
    idcode[32] = 10012;
    center[32] = 299;
    typid[32] = 299;
    type__[32] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 33, "IAU_EARTH", 
	    name_len, (ftnlen)9);
    idcode[33] = 10013;
    center[33] = 399;
    typid[33] = 399;
    type__[33] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 34, "IAU_MARS", name_len,
	     (ftnlen)8);
    idcode[34] = 10014;
    center[34] = 499;
    typid[34] = 499;
    type__[34] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 35, "IAU_JUPITER", 
	    name_len, (ftnlen)11);
    idcode[35] = 10015;
    center[35] = 599;
    typid[35] = 599;
    type__[35] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 36, "IAU_SATURN", 
	    name_len, (ftnlen)10);
    idcode[36] = 10016;
    center[36] = 699;
    typid[36] = 699;
    type__[36] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 37, "IAU_URANUS", 
	    name_len, (ftnlen)10);
    idcode[37] = 10017;
    center[37] = 799;
    typid[37] = 799;
    type__[37] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 38, "IAU_NEPTUNE", 
	    name_len, (ftnlen)11);
    idcode[38] = 10018;
    center[38] = 899;
    typid[38] = 899;
    type__[38] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 39, "IAU_PLUTO", 
	    name_len, (ftnlen)9);
    idcode[39] = 10019;
    center[39] = 999;
    typid[39] = 999;
    type__[39] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 40, "IAU_MOON", name_len,
	     (ftnlen)8);
    idcode[40] = 10020;
    center[40] = 301;
    typid[40] = 301;
    type__[40] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 41, "IAU_PHOBOS", 
	    name_len, (ftnlen)10);
    idcode[41] = 10021;
    center[41] = 401;
    typid[41] = 401;
    type__[41] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 42, "IAU_DEIMOS", 
	    name_len, (ftnlen)10);
    idcode[42] = 10022;
    center[42] = 402;
    typid[42] = 402;
    type__[42] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 43, "IAU_IO", name_len, (
	    ftnlen)6);
    idcode[43] = 10023;
    center[43] = 501;
    typid[43] = 501;
    type__[43] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 44, "IAU_EUROPA", 
	    name_len, (ftnlen)10);
    idcode[44] = 10024;
    center[44] = 502;
    typid[44] = 502;
    type__[44] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 45, "IAU_GANYMEDE", 
	    name_len, (ftnlen)12);
    idcode[45] = 10025;
    center[45] = 503;
    typid[45] = 503;
    type__[45] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 46, "IAU_CALLISTO", 
	    name_len, (ftnlen)12);
    idcode[46] = 10026;
    center[46] = 504;
    typid[46] = 504;
    type__[46] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 47, "IAU_AMALTHEA", 
	    name_len, (ftnlen)12);
    idcode[47] = 10027;
    center[47] = 505;
    typid[47] = 505;
    type__[47] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 48, "IAU_HIMALIA", 
	    name_len, (ftnlen)11);
    idcode[48] = 10028;
    center[48] = 506;
    typid[48] = 506;
    type__[48] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 49, "IAU_ELARA", 
	    name_len, (ftnlen)9);
    idcode[49] = 10029;
    center[49] = 507;
    typid[49] = 507;
    type__[49] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 50, "IAU_PASIPHAE", 
	    name_len, (ftnlen)12);
    idcode[50] = 10030;
    center[50] = 508;
    typid[50] = 508;
    type__[50] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 51, "IAU_SINOPE", 
	    name_len, (ftnlen)10);
    idcode[51] = 10031;
    center[51] = 509;
    typid[51] = 509;
    type__[51] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 52, "IAU_LYSITHEA", 
	    name_len, (ftnlen)12);
    idcode[52] = 10032;
    center[52] = 510;
    typid[52] = 510;
    type__[52] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 53, "IAU_CARME", 
	    name_len, (ftnlen)9);
    idcode[53] = 10033;
    center[53] = 511;
    typid[53] = 511;
    type__[53] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 54, "IAU_ANANKE", 
	    name_len, (ftnlen)10);
    idcode[54] = 10034;
    center[54] = 512;
    typid[54] = 512;
    type__[54] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 55, "IAU_LEDA", name_len,
	     (ftnlen)8);
    idcode[55] = 10035;
    center[55] = 513;
    typid[55] = 513;
    type__[55] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 56, "IAU_THEBE", 
	    name_len, (ftnlen)9);
    idcode[56] = 10036;
    center[56] = 514;
    typid[56] = 514;
    type__[56] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 57, "IAU_ADRASTEA", 
	    name_len, (ftnlen)12);
    idcode[57] = 10037;
    center[57] = 515;
    typid[57] = 515;
    type__[57] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 58, "IAU_METIS", 
	    name_len, (ftnlen)9);
    idcode[58] = 10038;
    center[58] = 516;
    typid[58] = 516;
    type__[58] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 59, "IAU_MIMAS", 
	    name_len, (ftnlen)9);
    idcode[59] = 10039;
    center[59] = 601;
    typid[59] = 601;
    type__[59] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 60, "IAU_ENCELADUS", 
	    name_len, (ftnlen)13);
    idcode[60] = 10040;
    center[60] = 602;
    typid[60] = 602;
    type__[60] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 61, "IAU_TETHYS", 
	    name_len, (ftnlen)10);
    idcode[61] = 10041;
    center[61] = 603;
    typid[61] = 603;
    type__[61] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 62, "IAU_DIONE", 
	    name_len, (ftnlen)9);
    idcode[62] = 10042;
    center[62] = 604;
    typid[62] = 604;
    type__[62] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 63, "IAU_RHEA", name_len,
	     (ftnlen)8);
    idcode[63] = 10043;
    center[63] = 605;
    typid[63] = 605;
    type__[63] = 2;
    s_copy(&__global_state->f2c, name__ + (name_len << 6), "IAU_TITAN", 
	    name_len, (ftnlen)9);
    idcode[64] = 10044;
    center[64] = 606;
    typid[64] = 606;
    type__[64] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 65, "IAU_HYPERION", 
	    name_len, (ftnlen)12);
    idcode[65] = 10045;
    center[65] = 607;
    typid[65] = 607;
    type__[65] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 66, "IAU_IAPETUS", 
	    name_len, (ftnlen)11);
    idcode[66] = 10046;
    center[66] = 608;
    typid[66] = 608;
    type__[66] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 67, "IAU_PHOEBE", 
	    name_len, (ftnlen)10);
    idcode[67] = 10047;
    center[67] = 609;
    typid[67] = 609;
    type__[67] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 68, "IAU_JANUS", 
	    name_len, (ftnlen)9);
    idcode[68] = 10048;
    center[68] = 610;
    typid[68] = 610;
    type__[68] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 69, "IAU_EPIMETHEUS", 
	    name_len, (ftnlen)14);
    idcode[69] = 10049;
    center[69] = 611;
    typid[69] = 611;
    type__[69] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 70, "IAU_HELENE", 
	    name_len, (ftnlen)10);
    idcode[70] = 10050;
    center[70] = 612;
    typid[70] = 612;
    type__[70] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 71, "IAU_TELESTO", 
	    name_len, (ftnlen)11);
    idcode[71] = 10051;
    center[71] = 613;
    typid[71] = 613;
    type__[71] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 72, "IAU_CALYPSO", 
	    name_len, (ftnlen)11);
    idcode[72] = 10052;
    center[72] = 614;
    typid[72] = 614;
    type__[72] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 73, "IAU_ATLAS", 
	    name_len, (ftnlen)9);
    idcode[73] = 10053;
    center[73] = 615;
    typid[73] = 615;
    type__[73] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 74, "IAU_PROMETHEUS", 
	    name_len, (ftnlen)14);
    idcode[74] = 10054;
    center[74] = 616;
    typid[74] = 616;
    type__[74] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 75, "IAU_PANDORA", 
	    name_len, (ftnlen)11);
    idcode[75] = 10055;
    center[75] = 617;
    typid[75] = 617;
    type__[75] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 76, "IAU_ARIEL", 
	    name_len, (ftnlen)9);
    idcode[76] = 10056;
    center[76] = 701;
    typid[76] = 701;
    type__[76] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 77, "IAU_UMBRIEL", 
	    name_len, (ftnlen)11);
    idcode[77] = 10057;
    center[77] = 702;
    typid[77] = 702;
    type__[77] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 78, "IAU_TITANIA", 
	    name_len, (ftnlen)11);
    idcode[78] = 10058;
    center[78] = 703;
    typid[78] = 703;
    type__[78] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 79, "IAU_OBERON", 
	    name_len, (ftnlen)10);
    idcode[79] = 10059;
    center[79] = 704;
    typid[79] = 704;
    type__[79] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 80, "IAU_MIRANDA", 
	    name_len, (ftnlen)11);
    idcode[80] = 10060;
    center[80] = 705;
    typid[80] = 705;
    type__[80] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 81, "IAU_CORDELIA", 
	    name_len, (ftnlen)12);
    idcode[81] = 10061;
    center[81] = 706;
    typid[81] = 706;
    type__[81] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 82, "IAU_OPHELIA", 
	    name_len, (ftnlen)11);
    idcode[82] = 10062;
    center[82] = 707;
    typid[82] = 707;
    type__[82] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 83, "IAU_BIANCA", 
	    name_len, (ftnlen)10);
    idcode[83] = 10063;
    center[83] = 708;
    typid[83] = 708;
    type__[83] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 84, "IAU_CRESSIDA", 
	    name_len, (ftnlen)12);
    idcode[84] = 10064;
    center[84] = 709;
    typid[84] = 709;
    type__[84] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 85, "IAU_DESDEMONA", 
	    name_len, (ftnlen)13);
    idcode[85] = 10065;
    center[85] = 710;
    typid[85] = 710;
    type__[85] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 86, "IAU_JULIET", 
	    name_len, (ftnlen)10);
    idcode[86] = 10066;
    center[86] = 711;
    typid[86] = 711;
    type__[86] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 87, "IAU_PORTIA", 
	    name_len, (ftnlen)10);
    idcode[87] = 10067;
    center[87] = 712;
    typid[87] = 712;
    type__[87] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 88, "IAU_ROSALIND", 
	    name_len, (ftnlen)12);
    idcode[88] = 10068;
    center[88] = 713;
    typid[88] = 713;
    type__[88] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 89, "IAU_BELINDA", 
	    name_len, (ftnlen)11);
    idcode[89] = 10069;
    center[89] = 714;
    typid[89] = 714;
    type__[89] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 90, "IAU_PUCK", name_len,
	     (ftnlen)8);
    idcode[90] = 10070;
    center[90] = 715;
    typid[90] = 715;
    type__[90] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 91, "IAU_TRITON", 
	    name_len, (ftnlen)10);
    idcode[91] = 10071;
    center[91] = 801;
    typid[91] = 801;
    type__[91] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 92, "IAU_NEREID", 
	    name_len, (ftnlen)10);
    idcode[92] = 10072;
    center[92] = 802;
    typid[92] = 802;
    type__[92] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 93, "IAU_NAIAD", 
	    name_len, (ftnlen)9);
    idcode[93] = 10073;
    center[93] = 803;
    typid[93] = 803;
    type__[93] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 94, "IAU_THALASSA", 
	    name_len, (ftnlen)12);
    idcode[94] = 10074;
    center[94] = 804;
    typid[94] = 804;
    type__[94] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 95, "IAU_DESPINA", 
	    name_len, (ftnlen)11);
    idcode[95] = 10075;
    center[95] = 805;
    typid[95] = 805;
    type__[95] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 96, "IAU_GALATEA", 
	    name_len, (ftnlen)11);
    idcode[96] = 10076;
    center[96] = 806;
    typid[96] = 806;
    type__[96] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 97, "IAU_LARISSA", 
	    name_len, (ftnlen)11);
    idcode[97] = 10077;
    center[97] = 807;
    typid[97] = 807;
    type__[97] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 98, "IAU_PROTEUS", 
	    name_len, (ftnlen)11);
    idcode[98] = 10078;
    center[98] = 808;
    typid[98] = 808;
    type__[98] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 99, "IAU_CHARON", 
	    name_len, (ftnlen)10);
    idcode[99] = 10079;
    center[99] = 901;
    typid[99] = 901;
...
/*     frame ITRF93. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 100, "ITRF93", name_len, 
	    (ftnlen)6);
    idcode[100] = 13000;
    center[100] = 399;
    typid[100] = 3000;
...
/*     FURNSH. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 101, "EARTH_FIXED", 
	    name_len, (ftnlen)11);
    idcode[101] = 10081;
    center[101] = 399;
    typid[101] = 10081;
...
/*     system as referenced from the 1997 IAU report. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 102, "IAU_PAN", name_len,
	     (ftnlen)7);
    idcode[102] = 10082;
    center[102] = 618;
    typid[102] = 618;
    type__[102] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 103, "IAU_GASPRA", 
	    name_len, (ftnlen)10);
    idcode[103] = 10083;
    center[103] = 9511010;
    typid[103] = 9511010;
    type__[103] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 104, "IAU_IDA", name_len,
	     (ftnlen)7);
    idcode[104] = 10084;
    center[104] = 2431010;
    typid[104] = 2431010;
...
/*     report. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 105, "IAU_EROS", 
	    name_len, (ftnlen)8);
    idcode[105] = 10085;
    center[105] = 2000433;
    typid[105] = 2000433;
...
/*     Frames for Jovian satellites approved by IAU in late 2002. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 106, "IAU_CALLIRRHOE", 
	    name_len, (ftnlen)14);
    idcode[106] = 10086;
    center[106] = 517;
    typid[106] = 517;
    type__[106] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 107, "IAU_THEMISTO", 
	    name_len, (ftnlen)12);
    idcode[107] = 10087;
    center[107] = 518;
    typid[107] = 518;
    type__[107] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 108, "IAU_MAGACLITE", 
	    name_len, (ftnlen)13);
    idcode[108] = 10088;
    center[108] = 519;
    typid[108] = 519;
    type__[108] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 109, "IAU_TAYGETE", 
	    name_len, (ftnlen)11);
    idcode[109] = 10089;
    center[109] = 520;
    typid[109] = 520;
    type__[109] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 110, "IAU_CHALDENE", 
	    name_len, (ftnlen)12);
    idcode[110] = 10090;
    center[110] = 521;
    typid[110] = 521;
    type__[110] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 111, "IAU_HARPALYKE", 
	    name_len, (ftnlen)13);
    idcode[111] = 10091;
    center[111] = 522;
    typid[111] = 522;
    type__[111] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 112, "IAU_KALYKE", 
	    name_len, (ftnlen)10);
    idcode[112] = 10092;
    center[112] = 523;
    typid[112] = 523;
    type__[112] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 113, "IAU_IOCASTE", 
	    name_len, (ftnlen)11);
    idcode[113] = 10093;
    center[113] = 524;
    typid[113] = 524;
    type__[113] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 114, "IAU_ERINOME", 
	    name_len, (ftnlen)11);
    idcode[114] = 10094;
    center[114] = 525;
    typid[114] = 525;
    type__[114] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 115, "IAU_ISONOE", 
	    name_len, (ftnlen)10);
    idcode[115] = 10095;
    center[115] = 526;
    typid[115] = 526;
    type__[115] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 116, "IAU_PRAXIDIKE", 
	    name_len, (ftnlen)13);
    idcode[116] = 10096;
    center[116] = 527;
    typid[116] = 527;
...
/*     were added in 2006 IAU Report. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 117, "IAU_BORRELLY", 
	    name_len, (ftnlen)12);
    idcode[117] = 10097;
    center[117] = 1000005;
    typid[117] = 1000005;
    type__[117] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 118, "IAU_TEMPEL_1", 
	    name_len, (ftnlen)12);
    idcode[118] = 10098;
    center[118] = 1000093;
    typid[118] = 1000093;
    type__[118] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 119, "IAU_VESTA", 
	    name_len, (ftnlen)9);
    idcode[119] = 10099;
    center[119] = 2000004;
    typid[119] = 2000004;
    type__[119] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 120, "IAU_ITOKAWA", 
	    name_len, (ftnlen)11);
    idcode[120] = 10100;
    center[120] = 2025143;
    typid[120] = 2025143;
...
/*     2009 IAU Report. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 121, "IAU_CERES", 
	    name_len, (ftnlen)9);
    idcode[121] = 10101;
    center[121] = 2000001;
    typid[121] = 2000001;
    type__[121] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 122, "IAU_PALLAS", 
	    name_len, (ftnlen)10);
    idcode[122] = 10102;
    center[122] = 2000002;
    typid[122] = 2000002;
    type__[122] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 123, "IAU_LUTETIA", 
	    name_len, (ftnlen)11);
    idcode[123] = 10103;
    center[123] = 2000021;
    typid[123] = 2000021;
    type__[123] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 124, "IAU_DAVIDA", 
	    name_len, (ftnlen)10);
    idcode[124] = 10104;
    center[124] = 2000511;
    typid[124] = 2000511;
    type__[124] = 2;
    s_copy(&__global_state->f2c, name__ + name_len * 125, "IAU_STEINS", 
	    name_len, (ftnlen)10);
    idcode[125] = 10105;
    center[125] = 2002867;
    typid[125] = 2002867;
...
/*     Frame for Bennu asteroid, for OSIRIS-Rex project. */
    ...
    s_copy(&__global_state->f2c, name__ + name_len * 126, "IAU_BENNU", 
	    name_len, (ftnlen)9);
    idcode[126] = 10106;
    center[126] = 2101955;
    typid[126] = 2101955;
...
/*     Generate order vector for centers (used by CIDFRM). */
    ...
    orderi_(__global_state, center, &__state->c__127, centrd);

/*     Initialize build-in frame name- and ID-based hashes. */

    zzhscini_(__global_state, maxbfr, bnmlst, bnmpol);
    zzhsiini_(__global_state, maxbfr, bidlst, bidpol);

/*     Register all built-in frames in the frame name- and ID-based */
/*     hashes. */

    for (i__ = 1; i__ <= 127; ++i__) {
	zzhscadd_(__global_state, bnmlst, bnmpol, bnmnms, name__ + (i__ - 1) *
		 name_len, &item, &new__, bnmnms_len, name_len);
	bnmidx[item - 1] = i__;
	zzhsiadd_(__global_state, bidlst, bidpol, bidids, &idcode[i__ - 1], &
		item, &new__);
	bididx[item - 1] = i__;
    }
    return 0;
