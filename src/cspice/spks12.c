...
/* Subroutine */ int spks12_(cspice_t* __global_state, integer *handle, 
	integer *baddr, integer *eaddr, doublereal *begin, doublereal *end)
{
    ...
    /* Module state */
    spks12_state_t* __state = get_spks12_state(__global_state);
/* $ Abstract */
