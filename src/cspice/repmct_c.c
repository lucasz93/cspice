...
{ /* Begin repmct_c */
   ...
   */
   CHKPTR( naif_state, CHK_DISCOVER, "repmct_c", in     );
   CHKPTR( naif_state, CHK_DISCOVER, "repmct_c", marker );
   CHKPTR( naif_state, CHK_DISCOVER, "repmct_c", out    );
