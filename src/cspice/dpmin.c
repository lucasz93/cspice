...
-Procedure dpmin_ ( Smallest DP number )
...
-Detailed_Output
   ...
   Therefore dpmin_ usually returns a value less than or equal to 
...
-Examples
   ...
   The following code fragments illustrate the use of dpmin_. 
