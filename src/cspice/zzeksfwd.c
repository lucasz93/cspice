/* zzeksfwd.f -- translated by f2c (version 19991025).
...
static zzeksfwd_state_t* get_zzeksfwd_state(cspice_t* state) {
	return 0;
}
...
/*     This routine sets the forward data pointer of the specified EK */
