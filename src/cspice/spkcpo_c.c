...
{ /* Begin spkcpo_c */
   ...
   */
   CHKPTR ( naif_state, CHK_STANDARD, "spkcpo_c", obspos );

   /*
   Check the input strings.
   */
   CHKFSTR ( naif_state, CHK_STANDARD, "spkcpo_c", target );
   CHKFSTR ( naif_state, CHK_STANDARD, "spkcpo_c", outref );
   CHKFSTR ( naif_state, CHK_STANDARD, "spkcpo_c", refloc );
   CHKFSTR ( naif_state, CHK_STANDARD, "spkcpo_c", abcorr );
   CHKFSTR ( naif_state, CHK_STANDARD, "spkcpo_c", obsctr );
   CHKFSTR ( naif_state, CHK_STANDARD, "spkcpo_c", obsref );

   /*
   Check the output pointers.
   */
   CHKPTR ( naif_state, CHK_STANDARD, "spkcpo_c", state );
   CHKPTR ( naif_state, CHK_STANDARD, "spkcpo_c", lt    );
