...
static zzdynfrm_state_t* get_zzdynfrm_state() {
	...
	et, doublereal *xform, integer *basfrm)
{
    ...
    /* Module state */
    zzdynfrm_state_t* __state = get_zzdynfrm_state();
/* $ Abstract */
...
/* Writing concatenation */
	    i__3[0] = 4, a__1[0] = __state->vname + (((i__2 = i__ - 1) < 2 && 
		    0 <= i__2 ? i__2 : s_rnge("vname", i__2, "zzdynfrm_", (
		    ftnlen)520)) << 2);
	    i__3[1] = 4, a__1[1] = "AXIS";
	    s_cat(__state->itmaxe + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmaxe", i__1, "zzdynfrm_", (ftnlen)520)) 
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmvdf + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmvdf", i__1, "zzdynfrm_", (ftnlen)524)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmabc + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmabc", i__1, "zzdynfrm_", (ftnlen)528)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmfrm + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmfrm", i__1, "zzdynfrm_", (ftnlen)532)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmobs + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmobs", i__1, "zzdynfrm_", (ftnlen)536)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmtrg + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmtrg", i__1, "zzdynfrm_", (ftnlen)540)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmlon + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmlon", i__1, "zzdynfrm_", (ftnlen)544)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmlat + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmlat", i__1, "zzdynfrm_", (ftnlen)548)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmra + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? i__1 
		    : s_rnge("itmra", i__1, "zzdynfrm_", (ftnlen)552)) << 5), 
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmdec + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmdec", i__1, "zzdynfrm_", (ftnlen)556)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmunt + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmunt", i__1, "zzdynfrm_", (ftnlen)560)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmspc + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmspc", i__1, "zzdynfrm_", (ftnlen)564)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    s_cat(__state->itmvec + (((i__1 = i__ - 1) < 2 && 0 <= i__1 ? 
		    i__1 : s_rnge("itmvec", i__1, "zzdynfrm_", (ftnlen)568)) 
		    << 5), a__1, i__3, &__state->c__2, (ftnlen)32);
	}
...
/*           transformation from J2000 to the base frame. */
		...
		zzfrmch0_(&__state->j2000, basfrm, &t0, xf2000);
...
/*              defining vector. */
		...
		zzdynvac_(inname__, infram, __state->itmaxe + (((i__1 = i__ - 
			...
			"zzdynfrm_", (ftnlen)1087)) << 5), &__state->c__1, &n,
...
/*                 We need a target, observer, and aberration correction. */
		    ...
		    zzdynbid_(inname__, infram, __state->itmtrg + (((i__1 = 
			    i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("itmtrg"
			    , i__1, "zzdynfrm_", (ftnlen)1176)) << 5), &targ, 
			    (ftnlen)32, (ftnlen)32);
		    zzdynbid_(inname__, infram, __state->itmobs + (((i__1 = 
			    i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("itmobs"
			    , i__1, "zzdynfrm_", (ftnlen)1178)) << 5), &obs, (
			    ftnlen)32, (ftnlen)32);
		    zzdynvac_(inname__, infram, __state->itmabc + (((i__1 = 
			    i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("itmabc"
			    , i__1, "zzdynfrm_", (ftnlen)1180)) << 5), &
			    __state->c__1, &n, abcorr, (ftnlen)32, (ftnlen)32,
			     (ftnlen)5);
...
/*                 defined. */
		    ...
		    zzdynfid_(inname__, infram, __state->itmfrm + (((i__1 = 
			    ...
			    , i__1, "zzdynfrm_", (ftnlen)1187)) << 5), &frid, 
			    (ftnlen)32, (ftnlen)32);
...
/*                 the J2000 frame. */
			...
			zzfrmch0_(&frid, &__state->j2000, &vet, xf2000);
			if (failed_()) {
			    chkout_("ZZDYNFRM", (ftnlen)8);
			    return 0;
			}
...
/*                 We need a target, observer, and aberration correction. */
		    ...
		    zzdynbid_(inname__, infram, __state->itmtrg + (((i__1 = 
			    i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("itmtrg"
			    , i__1, "zzdynfrm_", (ftnlen)1341)) << 5), &targ, 
			    (ftnlen)32, (ftnlen)32);
		    zzdynbid_(inname__, infram, __state->itmobs + (((i__1 = 
			    i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("itmobs"
			    , i__1, "zzdynfrm_", (ftnlen)1343)) << 5), &obs, (
			    ftnlen)32, (ftnlen)32);
		    zzdynvac_(inname__, infram, __state->itmabc + (((i__1 = 
			    i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("itmabc"
			    , i__1, "zzdynfrm_", (ftnlen)1345)) << 5), &
			    __state->c__1, &n, abcorr, (ftnlen)32, (ftnlen)32,
			     (ftnlen)5);
...
/*                 apply it to the observer-to-near point state vector. */
		    ...
		    zzfrmch0_(&cfrmid, &__state->j2000, &fet, xipm);
		    if (failed_()) {
			chkout_("ZZDYNFRM", (ftnlen)8);
			return 0;
		    }
		    mxvg_(xipm, stemp, &__state->c__6, &__state->c__6, &s2[(
			    ...
			    s_rnge("s2", i__1, "zzdynfrm_", (ftnlen)1476)]);
...
/*                 Look up the ID of the frame first. */
		    ...
		    zzdynfid_(inname__, infram, __state->itmfrm + (((i__1 = 
			    i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("itmfrm"
			    , i__1, "zzdynfrm_", (ftnlen)1494)) << 5), &frid, 
			    (ftnlen)32, (ftnlen)32);
...
/*                 constant vector's frame is zero. */
		    ...
		    cleard_(&__state->c__3, &s2[(i__1 = i__ * 6 - 3) < 12 && 
			    0 <= i__1 ? i__1 : s_rnge("s2", i__1, "zzdynfrm_",
			     (ftnlen)1766)]);
		    if (frid != __state->j2000) {
			zzfrmch0_(&frid, &__state->j2000, &fet, xipm);
			if (failed_()) {
			    chkout_("ZZDYNFRM", (ftnlen)8);
			    return 0;
			}
...
/*              is invalid due to a lookup error. */
		...
		zzdynvad_(inname__, infram, __state->itmcof + (((i__1 = i__ - 
			...
			"zzdynfrm_", (ftnlen)1983)) << 5), &__state->c__20, &
			n, &coeffs[(i__2 = i__ * 20 - 20) < 60 && 0 <= i__2 ? 
			i__2 : s_rnge("coeffs", i__2, "zzdynfrm_", (ftnlen)
...
/*           out the derivative block. */
		...
		cleard_(&__state->c__3, &xform[(i__1 = i__ * 6 - 3) < 36 && 0 
			<= i__1 ? i__1 : s_rnge("xform", i__1, "zzdynfrm_", (
			ftnlen)2093)]);
	    }
	} else {
...
/*           transformation from the defined frame to the output frame. */
	    ...
	    zzfrmch0_(basfrm, &__state->j2000, &t0, xf2000);
	    if (failed_()) {
		chkout_("ZZDYNFRM", (ftnlen)8);
		return 0;
	    }
		...
		cleard_(&__state->c__3, &xftemp[(i__1 = i__ * 6 - 3) < 36 && 
			0 <= i__1 ? i__1 : s_rnge("xftemp", i__1, "zzdynfrm_",
			 (ftnlen)2115)]);
	    }
...
/*     transformation matrix. */
	...
	for (i__ = 1; i__ <= 3; ++i__) {
	    cleard_(&__state->c__3, &xform[(i__1 = i__ * 6 - 3) < 36 && 0 <= 
		    i__1 ? i__1 : s_rnge("xform", i__1, "zzdynfrm_", (ftnlen)
		    2147)]);
	}
    }
