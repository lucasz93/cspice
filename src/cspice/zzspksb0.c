/* zzspksb0.f -- translated by f2c (version 19991025).
...
typedef int zzspksb0_state_t;
static inline zzspksb0_state_t* get_zzspksb0_state(cspice_t* state) {
	return 0;
}

/* $Procedure ZZSPKSB0 ( S/P Kernel, solar system barycenter ) */
/* Subroutine */ int zzspksb0_(cspice_t* __global_state, integer *targ, 
	doublereal *et, char *ref, doublereal *starg, ftnlen ref_len)
{
    ...
    /* Module state */
    zzspksb0_state_t* __state = get_zzspksb0_state(__global_state);
/* $ Abstract */
...
/*     ZZSPKSB0 reads as many segments as necessary, from as many */
/*     files as necessary, using files that have been loaded by */
/*     previous calls to SPKLEF (load ephemeris file). */

/* $ Examples */

/*     In the following code fragment, ZZSPKSB0 is used to display */
...
/*           CALL ZZSPKSB0 ( EARTH, EPOCH, 'J2000', SEARTH ) */
/*           CALL ZZSPKSB0 ( MARS,  EPOCH, 'J2000', SMARS  ) */
...
/*     2) The ephemeris files to be used by ZZSPKSB0 must be loaded */
/*        by SPKLEF before ZZSPKSB0 is called. */
...
/*     Standard SPICE error handling. */
	...
	chkin_(__global_state, "ZZSPKSB0", (ftnlen)8);
    }
    bary = 0;
    zzspkgo0_(__global_state, targ, et, ref, &bary, starg, &lt, ref_len);
    chkout_(__global_state, "ZZSPKSB0", (ftnlen)8);
    return 0;
} /* zzspksb0_ */
