/* somfls.f -- translated by f2c (version 19991025).
...
logical somfls_(cspice_t* __global_state, logical *logcls, integer *n)
{
    ...
    /* Module state */
    somfls_state_t* __state = get_somfls_state(__global_state);
/* $ Abstract */
