...
/* Subroutine */ int pckfrm_(cspice_t* __global_state, char *pck, integer *
	ids, ftnlen pck_len)
{
    /* Builtin functions */
    ...
    /* Module state */
    pckfrm_state_t* __state = get_pckfrm_state(__global_state);
/* $ Abstract */
...
/*     Standard SPICE error handling. */
    ...
    chkin_(__global_state, "PCKFRM", (ftnlen)6);
...
/*     See whether GETFAT thinks we've got a PCK file. */
	...
	chkout_(__global_state, "PCKFRM", (ftnlen)6);
	return 0;
