...
{ /* Begin gfdist_c */
   ...
   */
   CELLTYPECHK2 ( naif_state, CHK_STANDARD, "gfdist_c", SPICE_DP, cnfine, result );
   ...
   */
   CHKFSTR ( naif_state, CHK_STANDARD, "gfdist_c", target );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfdist_c", abcorr );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfdist_c", obsrvr );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfdist_c", relate );
