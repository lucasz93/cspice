...
static inline pcke20_state_t* get_pcke20_state(cspice_t* state) {
	return 0;
}

/* $Procedure      PCKE20 ( PCK, evaluate record, type 20 ) */
/* Subroutine */ int pcke20_(cspice_t* __global_state, doublereal *et, 
	doublereal *record, doublereal *eulang)
{
    ...
    /* Module state */
    pcke20_state_t* __state = get_pcke20_state(__global_state);
/* $ Abstract */
