/* ncpos.f -- translated by f2c (version 19991025).
...
integer ncpos_(cspice_t* __global_state, char *str, char *chars, integer *
	start, ftnlen str_len, ftnlen chars_len)
{
    ...
    /* Module state */
    ncpos_state_t* __state = get_ncpos_state(__global_state);
/* $ Abstract */
