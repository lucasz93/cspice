...
static zzektrsz_state_t* get_zzektrsz_state(cspice_t* state) {
	return 0;
}
...
/*     This routine should be used to determine the current size of an */
/*     EK tree; the tree's metadata should not be accessed directly to */
