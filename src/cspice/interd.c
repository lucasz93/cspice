/* interd.f -- translated by f2c (version 19991025).
...
typedef int interd_state_t;
static inline interd_state_t* get_interd_state(cspice_t* state) {
	return 0;
}

/* $Procedure      INTERD ( Intersect two double precision sets ) */
/* Subroutine */ int interd_(cspice_t* __global_state, doublereal *a, 
	doublereal *b, doublereal *c__)
{
    ...
    /* Module state */
    interd_state_t* __state = get_interd_state(__global_state);
/* $ Abstract */
...
/*     Set up the error processing. */
    ...
    chkin_(__global_state, "INTERD", (ftnlen)6);
...
/*     Report any excess. */
    ...
    chkout_(__global_state, "INTERD", (ftnlen)6);
    return 0;
} /* interd_ */
