...
static inline sce2t_state_t* get_sce2t_state(cspice_t* state) {
	return 0;
}

/* $Procedure      SCE2T ( ET to discrete SCLK ticks ) */
/* Subroutine */ int sce2t_(cspice_t* __global_state, integer *sc, doublereal 
	*et, doublereal *sclkdp)
{
    ...
    extern /* Subroutine */ int scet01_(cspice_t*, integer *, doublereal *, 
	    doublereal *);
    ...
    /* Module state */
    sce2t_state_t* __state = get_sce2t_state(__global_state);
/* $ Abstract */
...
/*     Just hand off the conversion to the appropriate routine. */
	...
	chkout_(__global_state, "SCE2T", (ftnlen)5);
	return 0;
    }
    chkout_(__global_state, "SCE2T", (ftnlen)5);
    return 0;
