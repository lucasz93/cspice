/* spkobj.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int spkobj_(cspice_t* __global_state, char *spk, integer *
	ids, ftnlen spk_len)
{
    /* Builtin functions */
    ...
    /* Module state */
    spkobj_state_t* __state = get_spkobj_state(__global_state);
/* $ Abstract */
...
/*     Standard SPICE error handling. */
    ...
    chkin_(__global_state, "SPKOBJ", (ftnlen)6);
...
/*     See whether GETFAT thinks we've got an SPK file. */
	...
	chkout_(__global_state, "SPKOBJ", (ftnlen)6);
	return 0;
