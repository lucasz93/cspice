...
/* Subroutine */ int txtopr_(cspice_t* __global_state, char *fname, integer *
	unit, ftnlen fname_len)
{
    ...
    /* Module state */
    txtopr_state_t* __state = get_txtopr_state(__global_state);
/* $ Abstract */
...
/*     Standard SPICE error handling. */
	...
	chkin_(__global_state, "TXTOPR", (ftnlen)6);
    }
	...
	chkout_(__global_state, "TXTOPR", (ftnlen)6);
	return 0;
    }
