...
/* Subroutine */ int zzekde02_(cspice_t* __global_state, integer *handle, 
	integer *segdsc, integer *coldsc, integer *recptr)
{
    ...
    /* Module state */
    zzekde02_state_t* __state = get_zzekde02_state(__global_state);
/* $ Abstract */
...
/*     Standard SPICE error handling. */
    ...
    chkin_(__global_state, "ZZEKDE02", (ftnlen)8);
...
/*     access?  Signal an error if not. */
	...
	chkout_(__global_state, "ZZEKDE02", (ftnlen)8);
	return 0;
    }
