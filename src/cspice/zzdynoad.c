/* zzdynoad.f -- translated by f2c (version 19991025).
...
static zzdynoad_state_t* get_zzdynoad_state(cspice_t* state) {
	...
	return state->zzdynoad;

}

/* $Procedure ZZDYNOAD ( Fetch optional array, d.p. frame variable ) */
/* Subroutine */ int zzdynoad_(cspice_t* __global_state, char *frname, 
	integer *frcode, char *item, integer *maxn, integer *n, doublereal *
	values, logical *found, ftnlen frname_len, ftnlen item_len)
{
    ...
    /* Module state */
    zzdynoad_state_t* __state = get_zzdynoad_state(__global_state);
/* $ Abstract */
...
/*     Standard SPICE error handling */
    ...
    chkin_(__global_state, "ZZDYNOAD", (ftnlen)8);
...
/*     Convert the frame code to a string. */
	...
	chkout_(__global_state, "ZZDYNOAD", (ftnlen)8);
	return 0;
    }
