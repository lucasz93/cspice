...
static ekucec_state_t* get_ekucec_state() {
	...
	column_len, ftnlen cvals_len)
{
    ...
    extern /* Subroutine */ int zzekue03_(integer *, integer *, integer *, 
	    integer *, char *, logical *, ftnlen);
    extern /* Subroutine */ int zzekue06_(integer *, integer *, integer *, 
	    integer *, integer *, char *, logical *, ftnlen);


    /* Module state */
    ekucec_state_t* __state = get_ekucec_state();
/* $ Abstract */
