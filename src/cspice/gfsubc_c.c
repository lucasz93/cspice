...
*/
   ...
   */
   CELLTYPECHK2 ( naif_state, CHK_STANDARD, "gfsubc_c", SPICE_DP, cnfine, result );
   ...
   */
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", target );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", fixref );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", method );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", abcorr );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", obsrvr );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", crdsys );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", coord  );
   CHKFSTR ( naif_state, CHK_STANDARD, "gfsubc_c", relate );
