...
static inline cknr04_state_t* get_cknr04_state(cspice_t* state) {
	if (!state->cknr04)
...
/* Subroutine */ int cknr04_(cspice_t* __global_state, integer *handle, 
	doublereal *descr, integer *nrec)
{
    ...
    /* Module state */
    cknr04_state_t* __state = get_cknr04_state(__global_state);
/* $ Abstract */
...
/*     Standard SPICE error handling. */
	...
	chkin_(__global_state, "CKNR04", (ftnlen)6);
    }
...
/*     descriptor and checking value of its third integer component. */
	...
	chkout_(__global_state, "CKNR04", (ftnlen)6);
	return 0;
    }
...
/*     details.) */
    ...
    sgmeta_(__global_state, handle, descr, &__state->c__12, nrec);
