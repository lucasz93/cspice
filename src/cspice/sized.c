/* sized.f -- translated by f2c (version 19991025).
...
integer sized_(cspice_t* __global_state, doublereal *cell)
{
    ...
    /* Module state */
    sized_state_t* __state = get_sized_state(__global_state);
/* $ Abstract */
...
/*     SPICELIB functions */
	...
	chkin_(__global_state, "SIZED", (ftnlen)5);
    }
...
/*     Squeal if something is awry. */
	...
	chkout_(__global_state, "SIZED", (ftnlen)5);
	return ret_val;
