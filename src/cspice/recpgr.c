...
/* Subroutine */ int recpgr_(cspice_t* __global_state, char *body, doublereal 
	*rectan, doublereal *re, doublereal *f, doublereal *lon, doublereal *
	lat, doublereal *alt, ftnlen body_len)
{
    /* Initialized data */
    ...
    /* Module state */
    recpgr_state_t* __state = get_recpgr_state(__global_state);
/* $ Abstract */
...
/*     Standard SPICE error handling. */
    ...
    chkin_(__global_state, "RECPGR", (ftnlen)6);
...
/*     Convert the body name to an ID code. */
	...
	chkout_(__global_state, "RECPGR", (ftnlen)6);
	return 0;
    }
...
/*     Convert the input coordinates first to geodetic coordinates. */
    ...
    recgeo_(__global_state, rectan, re, f, lon, lat, alt);
