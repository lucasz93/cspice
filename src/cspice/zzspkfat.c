...
static zzspkfat_state_t* get_zzspkfat_state(cspice_t* state) {
	if (!state->zzspkfat)
...
/*     frame. An input subroutine provides the state of the target */
...
/*     3) The kernel files to be used by ZZSPKFAT must be loaded */
...
/*     Last update was 09-JAN-2012 (NJB) */
