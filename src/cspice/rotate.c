/* rotate.f -- translated by f2c (version 19991025).
...
extern rotate_init_t __rotate_init;
static inline rotate_state_t* get_rotate_state(cspice_t* state) {
	if (!state->rotate)
		state->rotate = __cspice_allocate_module(sizeof(
	rotate_state_t), &__rotate_init, sizeof(__rotate_init));
	return state->rotate;

}

/* $Procedure      ROTATE ( Generate a rotation matrix ) */
/* Subroutine */ int rotate_(cspice_t* __global_state, doublereal *angle, 
	integer *iaxis, doublereal *mout)
{
    /* Initialized data */
    ...
    /* Module state */
    rotate_state_t* __state = get_rotate_state(__global_state);
/* $ Abstract */
...
/*  non-negative value of IAXIS mod 3 . */
    ...
    i1 = __state->indexs[(i__1 = temp) < 5 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "indexs", i__1, "rotate_", (ftnlen)189)];
    i2 = __state->indexs[(i__1 = temp + 1) < 5 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "indexs", i__1, "rotate_", (ftnlen)190)];
    i3 = __state->indexs[(i__1 = temp + 2) < 5 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "indexs", i__1, "rotate_", (ftnlen)191)];

/*  Construct the rotation matrix */

    mout[(i__1 = i1 + i1 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)196)] = 1.;
    mout[(i__1 = i2 + i1 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)197)] = 0.;
    mout[(i__1 = i3 + i1 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)198)] = 0.;
    mout[(i__1 = i1 + i2 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)199)] = 0.;
    mout[(i__1 = i2 + i2 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)200)] = c__;
    mout[(i__1 = i3 + i2 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)201)] = -s;
    mout[(i__1 = i1 + i3 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)202)] = 0.;
    mout[(i__1 = i2 + i3 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)203)] = s;
    mout[(i__1 = i3 + i3 * 3 - 4) < 9 && 0 <= i__1 ? i__1 : s_rnge(&
	    __global_state->f2c, "mout", i__1, "rotate_", (ftnlen)204)] = c__;
