	...
	logical *found, ftnlen name_len)
{
    ...
    static thread_local integer codes[415] = { 199,299,399,499,599,699,799,
	    899,999,301,401,402,501,502,503,504,505,506,507,508,509,510,511,
	    512,513,514,514,515,515,516,516,601,602,603,604,605,606,607,608,
	    609,610,610,611,611,612,612,613,613,614,614,615,615,616,616,617,
	    617,701,702,703,704,705,706,706,707,707,708,708,709,709,710,710,
	    711,711,712,712,713,713,714,714,715,715,801,802,803,804,805,806,
	    807,808,901,901,-12,-12,-12,-18,-18,-27,-27,-30,-30,-31,-31,-32,
	    -32,-46,-46,-47,-47,-58,-66,-67,-77,-77,-78,-94,-94,-112,0,0,1,2,
	    3,3,3,3,4,5,6,7,8,9,10,9511010,2431010,1000001,1000002,1000003,
	    1000004,1000005,1000006,1000007,1000008,1000009,1000010,1000011,
	    1000012,1000013,1000014,1000015,1000016,1000017,1000018,1000019,
	    1000020,1000021,1000022,1000023,1000024,1000025,1000026,1000027,
	    1000028,1000029,1000030,1000031,1000032,1000033,1000034,1000035,
	    1000036,1000037,1000038,1000039,1000040,1000041,1000042,1000043,
	    1000044,1000045,1000046,1000047,1000048,1000049,1000050,1000051,
	    1000052,1000053,1000054,1000055,1000056,1000057,1000058,1000059,
	    1000060,1000061,1000062,1000063,1000064,1000065,1000066,1000067,
	    1000068,1000069,1000070,1000071,1000072,1000073,1000074,1000075,
	    1000076,1000077,1000078,1000079,1000080,1000081,1000082,1000083,
	    1000084,1000085,1000086,1000087,1000088,1000089,1000090,1000091,
	    1000092,1000093,1000094,1000095,1000096,1000097,1000098,1000099,
	    1000100,1000101,1000102,1000103,1000104,1000105,1000106,1000107,
	    1000108,1000109,1000110,1000111,1000112,1000113,1000114,1000115,
	    1000116,1000117,1000118,1000119,1000120,1000121,1000122,1000123,
	    1000124,1000125,1000126,1000127,1000128,1000129,1000130,50000001,
	    50000002,50000003,50000004,50000005,50000006,50000007,50000008,
	    50000009,50000010,50000011,50000012,50000013,50000014,50000015,
	    50000016,50000017,50000018,50000019,50000020,50000021,50000022,
	    50000023,-40,-344,-344,2000433,2000253,618,-59,-53,-53,-93,-93,
	    -82,-82,-150,-55,399001,399002,399003,399004,1000131,1000132,-550,
	    -550,-550,-550,-90,-95,-81 };
    static thread_local char names[32*415] = "MERCURY                       "
	    "  " "VENUS                           " "EARTH                   "
	    "        " "MARS                            " "JUPITER           "
	    "              " "SATURN                          " "URANUS      "
	    "                    " "NEPTUNE                         " "PLUTO "
	    ...
	    "                      " "SSB                             " "SOLA"
	    "R SYSTEM BARYCENTER         " "MERCURY BARYCENTER              " 
	    "VENUS BARYCENTER                " "EMB                         "
	    "    " "EARTH MOON BARYCENTER           " "EARTH-MOON BARYCENTER "
	    "          " "EARTH BARYCENTER                " "MARS BARYCENTER "
	    "                " "JUPITER BARYCENTER              " "SATURN BAR"
	    "YCENTER               " "URANUS BARYCENTER               " "NEPT"
	    "UNE BARYCENTER              " "PLUTO BARYCENTER                " 
	    "SUN                             " "GASPRA                      "
	    "    " "IDA                             " "AREND                 "
	    ...
	    "FIELD                       " "BROOKS 2                        " 
	    "BRORSEN-METCALF                 " "BUS                         "
	    "    " "CHERNYKH                        " "CHURYUMOV-GERASIMENKO "
	    "          " "CIFFREO                         " "CLARK           "
	    "                " "COMAS SOLA                      " "CROMMELIN "
	    "                      " "D'ARREST                        " "DANI"
	    "EL                          " "DE VICO-SWIFT                   " 
	    "DENNING-FUJIKAWA                " "DU TOIT 1                   "
	    "    " "DU TOIT-HARTLEY                 " "DUTOIT-NEUJMIN-DELPORT"
	    "E         " "DUBIAGO                         " "ENCKE           "
	    "                " "FAYE                            " "FINLAY    "
	    "                      " "FORBES                          " "GEHR"
	    "ELS 1                       " "GEHRELS 2                       " 
	    "GEHRELS 3                       " "GIACOBINI-ZINNER            "
	    "    " "GICLAS                          " "GRIGG-SKJELLERUP      "
	    "          " "GUNN                            " "HALLEY          "
	    "                " "HANEDA-CAMPOS                   " "HARRINGTON"
	    "                      " "HARRINGTON-ABELL                " "HART"
	    "LEY 1                       " "HARTLEY 2                       " 
	    "HARTLEY-IRAS                    " "HERSCHEL-RIGOLLET           "
	    "    " "HOLMES                          " "HONDA-MRKOS-PAJDUSAKOV"
	    "A         " "HOWELL                          " "IRAS            "
	    ...
	    "RUSSELL 4                       " "SANGUIN                     "
	    "    " "SCHAUMASSE                      " "SCHUSTER              "
	    "          " "SCHWASSMANN-WACHMANN 1          " "SCHWASSMANN-WACH"
	    "MANN 2          " "SCHWASSMANN-WACHMANN 3          " "SHAJN-SCHA"
	    "LDACH                 " "SHOEMAKER 1                     " "SHOE"
	    "MAKER 2                     " "SHOEMAKER 3                     " 
	    "SINGER-BREWSTER                 " "SLAUGHTER-BURNHAM           "
	    "    " "SMIRNOVA-CHERNYKH               " "STEPHAN-OTERMA        "
	    "          " "SWIFT-GEHRELS                   " "TAKAMIZAWA      "
	    "                " "TAYLOR                          " "TEMPEL 1  "
	    "                      " "TEMPEL 2                        " "TEMP"
	    "EL-TUTTLE                   " "TRITTON                         " 
	    "TSUCHINSHAN 1                   " "TSUCHINSHAN 2               "
	    "    " "TUTTLE                          " "TUTTLE-GIACOBINI-KRESA"
	    "K         " "VAISALA 1                       " "VAN BIESBROECK  "
	    "                " "VAN HOUTEN                      " "WEST-KOHOU"
	    "TEK-IKEMURA           " "WHIPPLE                         " "WILD"
	    " 1                          " "WILD 2                          " 
	    "WILD 3                          " "WIRTANEN                    "
	    "    " "WOLF                            " "WOLF-HARRINGTON       "
	    "          " "LOVAS 2                         " "URATA-NIIJIMA   "
	    "                " "WISEMAN-SKIFF                   " "HELIN     "
	    "                      " "MUELLER                         " "SHOE"
	    "MAKER-HOLT 1                " "HELIN-ROMAN-CROCKETT            " 
	    "HARTLEY 3                       " "PARKER-HARTLEY              "
	    "    " "HELIN-ROMAN-ALU 1               " "WILD 4                "
	    "          " "MUELLER 2                       " "MUELLER 3       "
	    "                " "SHOEMAKER-LEVY 1                " "SHOEMAKER-"
	    "LEVY 2                " "HOLT-OLMSTEAD                   " "METC"
	    "ALF-BREWINGTON              " "LEVY                            " 
	    "SHOEMAKER-LEVY 9                " "SHOEMAKER-LEVY 9-W          "
	    "    " "SHOEMAKER-LEVY 9-V              " "SHOEMAKER-LEVY 9-U    "
	    "          " "SHOEMAKER-LEVY 9-T              " "SHOEMAKER-LEVY 9"
	    "-S              " "SHOEMAKER-LEVY 9-R              " "SHOEMAKER-"
	    "LEVY 9-Q              " "SHOEMAKER-LEVY 9-P              " "SHOE"
	    "MAKER-LEVY 9-N              " "SHOEMAKER-LEVY 9-M              " 
	    "SHOEMAKER-LEVY 9-L              " "SHOEMAKER-LEVY 9-K          "
	    "    " "SHOEMAKER-LEVY 9-J              " "SHOEMAKER-LEVY 9-H    "
	    "          " "SHOEMAKER-LEVY 9-G              " "SHOEMAKER-LEVY 9"
	    "-F              " "SHOEMAKER-LEVY 9-E              " "SHOEMAKER-"
	    "LEVY 9-D              " "SHOEMAKER-LEVY 9-C              " "SHOE"
	    "MAKER-LEVY 9-B              " "SHOEMAKER-LEVY 9-A              " 
	    "SHOEMAKER-LEVY 9-Q1             " "SHOEMAKER-LEVY 9-P2         "
	    "    " "CLEMENTINE                      " "GLL PROBE             "
	    "          " "GALILEO PROBE                   " "EROS            "
	    "                " "MATHILDE                        " "PAN       "
	    "                      " "RADIOASTRON                     " "MARS"
	    " PATHFINDER                 " "MPF                             " 
	    "NEAR                            " "NEAR EARTH ASTEROID RENDEZVO"
	    "US  " "CASSINI                         " "CAS                   "
	    ...
	    "HALE-BOPP                       " "MARS-96                     "
	    "    " "M96                             " "MARS 96               "
	    "          " "MARS96                          " "CASSINI SIMULATI"
	    "ON              " "MGS SIMULATION                  " "CASSINI IT"
	    "L                     ";
    static thread_local logical init = TRUE_;
    static thread_local integer nnam = 315;
